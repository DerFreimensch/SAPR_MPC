...
// SAPR_MPC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSAPR_MPCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSAPR_MPCApp

CSAPR_MPCApp::CSAPR_MPCApp()
{
...
// Единственный объект CSAPR_MPCApp

CSAPR_MPCApp theApp;


// Инициализация CSAPR_MPCApp
